...
import static CPUScheduler.CalcSimulation.algo;
...
public class CalcSimulation extends javax.swing.JFrame {
    ...
    public CalcSimulation(Job[] jobBatch, int numOfJobs, String sourcePath, String algo) {
        ...
        // Map the waiting time labels to the corresponding GUI components
    ...
    public void start() {
        ...
        if(algo.equals("FCFS")) {
            ...
            CPUScheduler scheduler = new CPUScheduler(jobBatch, jTextArea1, selectedJob, 
            ...
            // Initialize the Priority Scheduling policy and scheduler
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 570, 330, 50));
        ...
        jLabel2.setText(" Queue de listos");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 550, 120, 20));
        ...
        jPanel1.add(algoSelected2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 70, 30));
        ...
        jLabel13.setText("Tiempo espera");
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 20, 100, 30));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Tiempo de ejecucion");
        ...
        jLabel17.setText("Tiempo espera promedio:");
        ...
        avgServeLabel.setText("Tiempo de Turnaround promedio:");
        jPanel1.add(avgServeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 250, 50));
        ...
        avgTurnLabel1.setText("Total tiempo de ejecucion:");
        ...
        pt2.setText("0");
        jPanel1.add(pt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 120, 30, 30));
